export const ko = {
    ...
    presetDefault: '기본',
    presetDefaultDesc: '모든 단계에서 CFG 적용. 균형 잡힌 품질.',
    presetCreative: '크리에이티브',
    presetCreativeDesc: 'CFG 15%-85%만——다양성을 위한 자유로운 시작, 부드러운 마무리.',
    presetStrict: '엄격',
    presetStrictDesc: '전체 CFG + 높은 스코어 스케일. 프롬프트를 더 정확하게 따름.',
    presetSmooth: '부드러움',
    presetSmoothDesc: 'CFG 처음 70%만——끝부분 가이던스 없이 부드러운 전환.',
    presetAdgDesc: '적응형 디노이징 가이던스——단계별로 CFG를 자동 조정.',
