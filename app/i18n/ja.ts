export const ja = {
  ...
  presetDefault: 'デフォルト',
  presetDefaultDesc: '全ステップでCFG適用。バランスの取れた品質。',
  presetCreative: 'クリエイティブ',
  presetCreativeDesc: 'CFGは15%-85%のみ——多様性のための自由な開始、柔らかな終了。',
  presetStrict: '厳密',
  presetStrictDesc: '完全CFG + 高スコアスケール。プロンプトにより忠実。',
  presetSmooth: 'スムーズ',
  presetSmoothDesc: 'CFGは最初の70%のみ——終盤はガイダンスなしで滑らかな遷移。',
  presetAdgDesc: '適応的デノイジングガイダンス——ステップごとにCFGを自動調整。',
