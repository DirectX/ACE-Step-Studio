export const zh = {
    ...
    presetDefault: '默认',
    presetDefaultDesc: '所有步骤应用CFG。平衡质量。',
    presetCreative: '创意',
    presetCreativeDesc: 'CFG仅15%-85%——自由开始以增加多样性，柔和结尾。',
    presetStrict: '严格',
    presetStrictDesc: '完整CFG + 更高评分比例。更严格地遵循提示词。',
    presetSmooth: '柔和',
    presetSmoothDesc: 'CFG仅前70%——结尾无引导以实现更平滑过渡。',
    presetAdgDesc: '自适应去噪引导——每步自动调整CFG。通常比手动更好。',
